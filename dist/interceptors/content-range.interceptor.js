...
let ContentRangeInterceptor = ContentRangeInterceptor_1 = class ContentRangeInterceptor {
    ...
    handleRelationalEntity(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const refId = args[0];
            let filter = args[1];
            const ref = (_a = (0, get_1.default)(controller.sourceRepository, relation.name)) === null || _a === void 0 ? void 0 : _a(refId);
            ...
            if (!filter) {
                filter = {
                    skip: 0,
                    limit: (_b = controller === null || controller === void 0 ? void 0 : controller.defaultLimit) !== null && _b !== void 0 ? _b : common_1.App.DEFAULT_QUERY_LIMIT,
                    where: {},
                };
            }
            const { limit = common_1.App.DEFAULT_QUERY_LIMIT, skip = 0, where } = filter;
            switch (relation.type) {
                case common_1.EntityRelations.HAS_MANY_THROUGH: {
                    ...
                    const countRs = yield controller.targetRepository.count(Object.assign(Object.assign({}, where), targetConstraint));
                    const start = 0 + skip;
                    const end = Math.min(start + limit, countRs.count);
                    this.response.set('Content-Range', `records ${start}-${end > 0 ? end - 1 : end}/${countRs.count}`);
                    break;
