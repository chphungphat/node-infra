...
const common_2 = require("../../components/migration/common");
...
class DefaultRestApplication extends base_application_1.BaseApplication {
    ...
    validateEnv() {
        ...
        for (const argKey of envKeys) {
            ...
            if ((0, utilities_1.toBoolean)(process.env.ALLOW_EMPTY_ENV_VALUE) || !(0, isEmpty_1.default)(argValue)) {
                continue;
            }
            rs.result = false;
    ...
    configureMigration() {
        this.bind(common_2.MigrationKeys.MIGRATION_DATASOURCE).toInjectable(datasources_1.PostgresDataSource);
