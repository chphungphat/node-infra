...
let AuthenticationMiddleware = AuthenticationMiddleware_1 = class AuthenticationMiddleware extends base_provider_1.BaseProvider {
...
exports.AuthenticationMiddleware = AuthenticationMiddleware = AuthenticationMiddleware_1 = __decorate([
    (0, core_1.injectable)((0, rest_1.asMiddleware)({
        ...
        upstreamGroups: [rest_1.RestMiddlewareGroups.CORS],
    })),
    __param(0, (0, core_1.inject)(authentication_1.AuthenticationBindings.AUTH_ACTION)),
    __param(1, core_1.inject.getter(common_1.AuthenticateKeys.ALWAYS_ALLOW_PATHS)),
