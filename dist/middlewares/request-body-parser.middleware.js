...
let RequestBodyParserMiddleware = RequestBodyParserMiddleware_1 = class RequestBodyParserMiddleware extends base_provider_1.BaseProvider {
    constructor() {
        ...
        return new Promise((resolve, reject) => {
            ...
            switch (contentType) {
                case 'application/x-www-form-urlencoded': {
                    const urlencoded = new rest_1.UrlEncodedBodyParser({
